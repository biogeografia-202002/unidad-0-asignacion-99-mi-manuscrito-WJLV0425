...
![Mapas asociación de especies por abundancia en los sitios de muestreo (superior) y por asociación de variables ambientales y abundancia (inferior). El color azul fuerte representa "lejanía" y el rosado fuerte "proximidad".\label{fig:heat}](Análisis/Imágenes_manuscrito/Heat_maps_Q.png){width=50%}
