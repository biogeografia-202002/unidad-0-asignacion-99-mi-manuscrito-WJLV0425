...
El agrupamiento jerarquico fue realizado mediante tres técnicas o criterios de enlace:
...
| Enlace medio                   | Pondera la media entre las distancias mínimas y máximas,  el resultado depende del tipo de "promedio" que se calcule:
UPGMA "Unweighted Pair Group Method with Arithmetic mean". 
WPGMA "Weighted Pair Group Method with Arithmetic mean". 
UPGMC "Unweighted Pair Group Method using Centroids".  
WPGMC "Weighted Pair Group Method using Centroids".  | Mismo procedimiento, pero se sustituye el método  por "average" o "ward.D2".                                                                                   |
