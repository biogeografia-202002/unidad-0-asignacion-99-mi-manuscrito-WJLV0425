...
El agrupamiento jerarquico fue analizado mediante tres técnicas o criterios de enlace, donde fueron seleccionados los criterios enlace simple y enlace promedrio de varianza mínima romando en cuenta métodos de regresión lineal [WARD].
...
En el dendrograma de WARD se observa la presencia de de tres grupos definidos entre los sitios C3-C7, C46-C34 y C27-C23. También pueden definirse cinco grupos menores más próximos entre sí: C3-C7 [sitios con abundacia y riqueza promedio], C46-C22, C27-C48, C50-C23 [citios con las mayores abundancias y riquezas, o al menos una de estas en forma de outlier].
