...
\begin{figure}
\centering
\includegraphics[width=1.00000\textwidth]{Análisis/Imágenes manuscrito/Heat_maps_Q.png}
...
\textbf{\emph{Insertar mapa de calor 1. aa\_2\_Modo\_Q}}
\textbf{\emph{Insertar mapa de calor 3 y 4 . aa\_2\_modo\_Q}} El color
rosado intenso representa ``mucha similaridad o distancia corta'',
mientras que el color azul intenso significa que los sitios están ``muy
alejados''.
